...
type Ad struct {
	...
	Platform     string    `gorm:"size:20;not null;uniqueIndex:uk_platform_ad"        json:"platform"`
	AdID         string    `gorm:"size:100;not null;uniqueIndex:uk_platform_ad"       json:"ad_id"`
